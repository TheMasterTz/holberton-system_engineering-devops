...
## Details
      By Sylvain Kalache          Weight: 1                Ongoing project - started 01-03-2022, must end by 01-04-2022 (in about 13 hours)          - you're done with 0% of tasks.              Checker will be released at 01-03-2022 03:36 PM              QA review fully automated.      ## Background Context
...
Obviously writing Puppet code for your infrastructure requires an investment of time and energy, but in the long term, it is for sure a must-have.<br />
 ![](https://s3.amazonaws.com/intranet-projects-files/holbertonschool-sysadmin_devops/292/4i8il3B.gif)<br />
